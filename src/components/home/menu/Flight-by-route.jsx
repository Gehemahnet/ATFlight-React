...
const FlightByRoute = ({parentClassName, setHomePageState}) => {
  ...
  return(
    <form className={parentClassName}>
      ...
      <CharterRentMenu
        ...
        className={radioState === 1? "flight-by-route__charter-rent _active": 'flight-by-route__charter-rent _disabled'}
      />
      <SeatTicketMenu
        setHomePageState={setHomePageState} 
        className={radioState === 2? "flight-by-route__seat-ticket _active": 'flight-by-route__seat-ticket _disabled'}
      />
